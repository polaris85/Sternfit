...
-(void)endTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event
{
    ...
    [appDelegate.rootView fadePopupViewInAndOut:NO];
    appDelegate.rootView.filterLabelAgeValue.text = [NSString stringWithFormat:@"%@ %d %@ %d", NSLocalizedString(@"From", nil), (int)self.lowerValue + 10, NSLocalizedString(@"to", nil), (int)self.upperValue + 10];
}
