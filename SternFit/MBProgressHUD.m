...
- (void)layoutSubviews {
	...
	CGSize labelSize = [label.text boundingRectWithSize:CGSizeMake(320,label.font.lineHeight)
	...
	CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:CGSizeMake(maxSize.width,detailsLabel.font.lineHeight)
                                                       options:NSStringDrawingUsesLineFragmentOrigin
                                                    attributes:@{NSFontAttributeName: detailsLabel.font}
                                                       context:nil].size;
    //[detailsLabel.text sizeWithFont:detailsLabel.font
